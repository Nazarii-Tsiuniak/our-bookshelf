  ...
  ngOnInit() {
    ...
    if (storedBooks) {
      ...
      this.books = [
        ...
        { id: 27, title: 'Великий Гетсбі', author: 'Френсіс Скотт Фіцджеральд', description: 'Американська класика про багатство, любов та трагедію.', language: 'uk', genre: 'Роман', coverUrl: 'assets/covers/27.jpg' },
